...
#define CREATE_PANEL( key ) kiface->CreateWindow( book, key, &Kiway() )
    ...
    book->AddSubPage( CREATE_PANEL( PANEL_3DV_DISPLAY_OPTIONS ), _( "Display Options" ) );
    book->AddSubPage( CREATE_PANEL( PANEL_3DV_OPENGL ), _( "OpenGL" ) );
    book->AddSubPage( CREATE_PANEL( PANEL_3DV_RAYTRACING ), _( "Raytracing" ) );
