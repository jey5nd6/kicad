                                            ...
                                            wxXmlNode* aWireNode, int aGateNumber )
{
    ...
    {
        LIB_SHAPE* poly = new LIB_SHAPE( aSymbol.get(), SHAPE_T::POLYGON );
...
void SCH_EAGLE_PLUGIN::loadFrame( wxXmlNode* aFrameNode, std::vector<LIB_ITEM*>& aItems )
{
    ...
    LIB_SHAPE* lines = new LIB_SHAPE( nullptr, SHAPE_T::POLYGON );
    ...
    {
        lines = new LIB_SHAPE( nullptr, SHAPE_T::POLYGON );
