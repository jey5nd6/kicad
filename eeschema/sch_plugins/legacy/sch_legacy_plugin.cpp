                                             ...
                                             LINE_READER&                 aReader )
{
    ...
    if( *line != 0 )
    {
        ...
        arc->SetArcStart( arcStart );
        arc->SetArcEnd( arcEnd );
    }
    else
    {
                                                ...
                                                LINE_READER&                 aReader )
{
    ...
    wxCHECK_MSG( strCompare( "C", line, &line ), NULL, "Invalid LIB_SHAPE definition" );
                                              ...
                                              LINE_READER&                 aReader )
{
    ...
    wxCHECK_MSG( strCompare( "S", line, &line ), NULL, "Invalid rectangle definition" );
                                                   ...
                                                   LINE_READER&                 aReader )
{
    ...
    LIB_SHAPE* polyLine = new LIB_SHAPE( aSymbol.get(), SHAPE_T::POLYGON );
                                                ...
                                                LINE_READER&                 aReader )
{
    ...
    wxCHECK_MSG( strCompare( "B", line, &line ), NULL, "Invalid Bezier definition" );

    int points = parseInt( aReader, line, &line );

    wxCHECK_MSG( points == 4, NULL, "Invalid Bezier curve definition" );

    LIB_SHAPE* bezier = new LIB_SHAPE( aSymbol.get(), SHAPE_T::CURVE );
    ...
    bezier->SetBezControl1( wxPoint( Mils2Iu( parseInt( aReader, line, &line ) ),
                                     Mils2Iu( parseInt( aReader, line, &line ) ) ) );

    bezier->SetBezControl2( wxPoint( Mils2Iu( parseInt( aReader, line, &line ) ),
                                     Mils2Iu( parseInt( aReader, line, &line ) ) ) );
