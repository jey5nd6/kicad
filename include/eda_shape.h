...
public:
    ...
    const wxPoint& GetArcMid() const               { return m_thirdPoint; }
    int GetArcMidY()                               { return m_thirdPoint.y; }
    int GetArcMidX()                               { return m_thirdPoint.x; }
    ...
    /**
     * @return the included angle of the arc, between 0 and 3600 in 0.1 deg.
     */
    ...
    /**
     * Yes, this version is over-specified.  But it's used in legacy files.
     * @param aStartAngle in degrees
     * @param aEndAngle in degrees
     */
    void SetArcGeometry( const wxPoint& aCenter, const wxPoint& aStart, const wxPoint& aEnd,
                         double aStartAngle, double aEndAngle );

    /**
     * This version is used by a lot of importers.
     */
    void SetArcGeometry( const wxPoint& aCenter, const wxPoint& aStart, double sweptAngle );

    /**
     * This version needs to know whether to take the short or long way around the circle, so
     * it's only good for updating existing arcs with the same inflection.
     */
    void UpdateArcGeometry( const VECTOR2I& aStart, const VECTOR2I& aEnd, const VECTOR2I& aCenter );
