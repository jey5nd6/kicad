            ...
            for( auto& gr_ref : gr_it->second )
            {
                ...
                for( auto& seg : *graphic.elements )
                {
                    ...
                    case GR_SHAPE_LINE:
                    {
                        ...
                        FP_SHAPE* line = new FP_SHAPE( fp, EDA_SHAPE_TYPE::SEGMENT );
                    ...
                    case GR_SHAPE_ARC:
                    {
                        ...
                        FP_SHAPE* arc = new FP_SHAPE( fp, EDA_SHAPE_TYPE::ARC );
                    ...
                    case GR_SHAPE_RECTANGLE:
                    {
                        ...
                        FP_SHAPE* rect = new FP_SHAPE( fp, EDA_SHAPE_TYPE::RECT );
...
bool FABMASTER::loadPolygon( BOARD* aBoard, const std::unique_ptr<FABMASTER::TRACE>& aLine)
{
    ...
    new_poly->SetShape( EDA_SHAPE_TYPE::POLYGON );
